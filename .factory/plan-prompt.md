...
For each unblocked issue, assign a branch name using the format `factory/issue-{number}-{slug}`.
...
<plan>
{"issues": [{"number": 42, "title": "Fix auth bug", "branch": "factory/issue-42-fix-auth-bug"}]}
</plan>
